...
-- Rol restaurant_admin omitido (no es necesario para el funcionamiento del sistema)
...
-- Funciones para triggers omitidas (no se utilizarán en este script)
...
-- Triggers omitidos (no se utilizarán en este script)

-- Triggers de reglas de negocio omitidos (no se utilizarán en este script)
